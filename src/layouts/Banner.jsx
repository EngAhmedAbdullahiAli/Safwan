...
const Banner = () => {
    return (
        <div>
            ...
            bg-cover bg-center py-[100px] md:py-[221px] mb-[220px] px-3 md:px-0'>
            ...
            bg-cover bg-center  duration-500'></div>
                <Container>  
                    <h1 className='text-4xl md:text-[120px] sm:text-[60px] sm:leading-[80px] md:leading-[100px] font-bold text-white'>Hello!  <span className='block'>I’m Zarror Nibors</span></h1>
